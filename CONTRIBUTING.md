# Contributing to senaite.ast

Third-party contributions are essential for keeping `senaite.ast` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.ast`. We want to keep it as easy as 
...
The following is a set of guidelines for contributing to `senaite.ast`, which is 
...
bugs](https://github.com/senaite/senaite.ast/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.ast/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.ast/issues).
...
The list of [open issues](https://github.com/senaite/senaite.ast/issues)
...
### Preliminaries
   ...
   2. [Fork senaite.ast from GitHub](
   https://github.com/senaite/senaite.ast/fork). This will copy the whole
   `senaite.ast` repository to your personal account.
   ...
   the actual username of your GitHub account):
          ...
          $ git clone https://github.com/YOUR_USERNAME/senaite.ast

   4. Your forked repository https://github.com/YOUR_USERNAME/senaite.ast will 
   receive the default name of `origin`. You can also add the original 
   `senaite.ast` repository, which is usually called `upstream`:

          $ cd senaite.ast
          $ git remote add upstream https://github.com/senaite/senaite.ast.git
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.ast.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.ast.git (push)
upstream  https://github.com/senaite/senaite.ast.git (fetch)
upstream  https://github.com/senaite/senaite.ast.git (push)
```
...
Alternatively, you can merge `senaite.ast`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.ast/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.ast/CHANGES.rst)
